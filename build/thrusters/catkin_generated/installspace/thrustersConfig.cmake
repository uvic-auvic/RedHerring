...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'thrusters' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/rosbox/control_code/install/${idir}'.  Ask the maintainer 'googly <googly@todo.todo>' to fix it.")
    endif()
